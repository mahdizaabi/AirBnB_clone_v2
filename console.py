...
class HBNBCommand(cmd.Cmd):
            ...
            if check_integer(item.split("=")[1]):
                ...
                for i in item.split("=")[1]:
                    if i == '_':
                        ...
                        flag = 1
                        new_dic[item.split("=")[0]] = m
                    if i == '\'':
                        z = item.split("=")[1].replace('\'', '')
                        new_dic[item.split("=")[0]] = z
                        flag = 1
                if flag == 0:
    ...
    def do_all(self, arg):
        ...
        if len(args) == 0:
            ...
            for keyx in storage.all().keys():
                if keyx.split(".")[0] == args[0]:
                    obj_dict[keyx] = storage.all()[keyx]
        else:
            print("** class doesn't exist **")
            return False
        for key in obj_dict:
